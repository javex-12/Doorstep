...
class _Translations$networkInterfacesPage$fi extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'Oletuksena Doorstep käyttää kaikkia saatavilla olevia verkkoliitäntöjä. Voit sulkea pois verkkoliitännät, joita et halua. Sinun tulee uudelleenkäynnistää Doorstep ottaaksesi muutokset käyttöön.';
  @override
...
class _Translations$receiveOptionsPage$fi extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Doorstep-kansio)';
  @override
...
class _Translations$webSharePage$fi extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Doorstep käyttää itse allekirjoitettua sertifikaattia. Sinun on hyväksyttävä se selaimessasi.';
  @override
...
class _Translations$aboutPage$fi extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Tietoja Doorstepista';
  @override
  List<String> get description => [
    'Doorstep on ilmainen, avoimen lähdekoodin sovellus, jonka avulla voit turvallisesti jakaa tiedostoja ja lähettää viestejä läheisten laitteiden kanssa paikallisessa verkossasi ilman internet-yhteyttä.',
    'Doorstep on saatavilla Androidille, iOS:lle, Linuxille, macOS:lle ja Windowsille. Kaikki latausvaihtoehdot löytyvät virallisilta kotisivuilta.',
  ];
  @override
...
class _Translations$donationPage$fi extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Doorstep on ilmainen, avoimen lähdekoodin sovellus ilman mainoksia. Voit tukea projektia lahjoituksella, jos pidät sovelluksesta.';
  @override
...
class _Translations$tray$fi extends Translations$tray$en {
  ...
  String get open => 'Avaa';
  @override
  String get close => 'Lopeta Doorstep';
  @override
...
class _Translations$settingsTab$general$fi extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Näytä Doorstep kontekstivalikossa';
  @override
...
class _Translations$settingsTab$network$fi extends Translations$settingsTab$network$en {
  ...
  @override
  String get needRestart => 'Käynnistä Doorstep uudelleen saadaksesi muutokset käyttöön!';
  @override
...
class _Translations$settingsTab$other$fi extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Tue Doorstepia';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$fi extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  @override
  String get description => 'Doorstep ei löydä muita laitteita ilman lupaa skannata paikallisverkkoa. Anna tämä lupa asetuksissa.';
  @override
...
class _Translations$dialogs$sendModeHelp$fi extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Vastaanottajat, joilla ei ole Doorstepia asennettuna, voivat ladata valitut tiedostot avaamalla linkin selaimessaan.';
}
