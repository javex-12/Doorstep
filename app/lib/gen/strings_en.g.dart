...
class Translations$networkInterfacesPage$en {
  ...
  /// en: 'By default, Doorstep uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, Doorstep uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class Translations$receiveOptionsPage$en {
  ...
  /// en: '(Doorstep folder)'
  String get appDirectory => '(Doorstep folder)';
...
class Translations$webSharePage$en {
  ...
  /// en: 'Doorstep uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'Doorstep uses a self-signed certificate. You need to accept it in your browser.';
...
class Translations$aboutPage$en {
  ...
  /// en: 'About Doorstep'
  String get title => 'About Doorstep';

  List<String> get description => [
    'Doorstep is a free, open-source app that lets you securely share files and messages with nearby devices over your local network, without needing an internet connection.',
    'This fork adds a persistent pair-and-drop workflow: pair your phone once by scanning a QR code, and files dropped into watched folders on your laptop arrive on your phone automatically.',
  ];
...
class Translations$donationPage$en {
  ...
  /// en: 'Doorstep is free, open-source and without any ads. If you like the app, you can support the development with a donation.'
  String get info => 'Doorstep is free, open-source and without any ads. If you like the app, you can support the development with a donation.';
...
class Translations$tray$en {
  ...
  /// en: 'Quit Doorstep'
  String get close => 'Quit Doorstep';
...
class Translations$settingsTab$general$en {
  ...
  /// en: 'Show Doorstep in context menu'
  String get showInContextMenu => 'Show Doorstep in context menu';
...
class Translations$settingsTab$other$en {
  ...
  /// en: 'Support Doorstep'
  String get support => 'Support Doorstep';
...
class Translations$dialogs$localNetworkUnauthorized$en {
  ...
  /// en: 'Doorstep can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'Doorstep can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class Translations$dialogs$sendModeHelp$en {
  ...
  /// en: 'Recipients who do not have Doorstep installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have Doorstep installed can download the selected files by opening the link in their browser.';
}
