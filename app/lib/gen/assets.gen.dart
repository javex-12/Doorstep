...
class $AssetsDoorstepGen {
  const $AssetsDoorstepGen();

  /// File path: assets/doorstep/loading.mp4
  String get loading => 'assets/doorstep/loading.mp4';

  /// File path: assets/doorstep/logo.png
  AssetGenImage get logo => const AssetGenImage('assets/doorstep/logo.png');
...
class Assets {
  ...
  static const $AssetsDoorstepGen doorstep = $AssetsDoorstepGen();
