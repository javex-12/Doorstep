...
class _Translations$networkInterfacesPage$ru extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'По умолчанию, Doorstep использует все доступные сетевые интерфейсы. Вы можете исключить нежелательные сети здесь. Необходимо перезапустить сервер для применения изменений.';
  @override
...
class _Translations$receiveOptionsPage$ru extends Translations$receiveOptionsPage$en {
  ...
  @override
  String get appDirectory => '(Папка Doorstep)';
  @override
...
class _Translations$webSharePage$ru extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Doorstep использует самоподписанный сертификат. Вам необходимо принять его в браузере.';
  @override
...
class _Translations$donationPage$ru extends Translations$donationPage$en {
  ...
  @override
  String get info =>
      'Doorstep — это бесплатное приложение с открытым исходным кодом и без рекламы. Если оно вам нравится, вы можете поддержать его разработку пожертвованием.';
  @override
...
class _Translations$tray$ru extends Translations$tray$en {
  ...
  @override
  String get close => 'Выйти из Doorstep';
  @override
...
class _Translations$settingsTab$general$ru extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Отображать Doorstep в контекстном меню';
  @override
...
class _Translations$settingsTab$other$ru extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Поддержать Doorstep';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$ru extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Doorstep не может найти другие устройства без разрешения на сканирование локальной сети. Пожалуйста, предоставьте это разрешение в настройках.';
  @override
...
class _Translations$dialogs$sendModeHelp$ru extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link => 'Получатели, у которых не установлен Doorstep, могут загрузить выбранные файлы, открыв ссылку в своем браузере.';
}
