...
class _Translations$networkInterfacesPage$es_ES extends Translations$networkInterfacesPage$en {
  ...
  @override
  String get info =>
      'De forma predeterminada, Doorstep utiliza todas las interfaces de red disponibles. Aquí puede desactivar las redes no deseadas. Debe reiniciar el servidor para aplicar los cambios.';
  @override
...
class _Translations$webSharePage$es_ES extends Translations$webSharePage$en {
  ...
  @override
  String get encryptionHint => 'Doorstep utiliza un certificado autofirmado. Necesitas aceptarlo en el navegador.';
  @override
...
class _Translations$aboutPage$es_ES extends Translations$aboutPage$en {
  ...
  // Translations
  @override
  String get title => 'Sobre Doorstep';
  @override
  List<String> get description => [
    'Doorstep es una aplicación libre, de código abierto, que te permite compartir archivos y mensajes de forma segura con dispositivos cercanos a través de tu red local sin necesidad de conexión a Internet.',
...
class _Translations$donationPage$es_ES extends Translations$donationPage$en {
  ...
  @override
  String get info => 'Doorstep es libre, open source y no contiene anuncios. Si te gusta la aplicación puedes ayudar al desarrollo con una donación.';
  @override
...
class _Translations$tray$es_ES extends Translations$tray$en {
  ...
  @override
  String get close => 'Cerrar Doorstep';
  @override
...
class _Translations$settingsTab$general$es_ES extends Translations$settingsTab$general$en {
  ...
  @override
  String get showInContextMenu => 'Mostrar Doorstep en el menú contextual';
  @override
...
class _Translations$settingsTab$other$es_ES extends Translations$settingsTab$other$en {
  ...
  @override
  String get support => 'Apoya a Doorstep';
  @override
...
class _Translations$dialogs$localNetworkUnauthorized$es_ES extends Translations$dialogs$localNetworkUnauthorized$en {
  ...
  String get description =>
      'Doorstep no puede encontrar otros dispositivos sin tener permiso para escanear la red local. Por favor, concede este permiso en los ajustes.';
  @override
...
class _Translations$dialogs$sendModeHelp$es_ES extends Translations$dialogs$sendModeHelp$en {
  ...
  @override
  String get link =>
      'Los destinatarios que no tengan Doorstep instalado pueden descargar los archivos seleccionados abriendo el enlace en su navegador.';
}
