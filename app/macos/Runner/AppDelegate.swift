...
class AppDelegate: FlutterAppDelegate {
    ...
    override func applicationShouldTerminateAfterLastWindowClosed(_ sender: NSApplication) -> Bool {
        // Doorstep handles the close event manually
        return false
    }
    ...
    override func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        let doorstepBrandColor = NSColor(red: 0.388, green: 0.4, blue: 0.945, alpha: 0.8) // #6366F1 (Doorstep Electric Indigo)
        DockProgress.style = .squircle(color: doorstepBrandColor)
    ...
    private func setupStatusBarItem(i18n: [String: String]) {
        ...
        if let button = statusItem?.button {
            ...
            let openItem = NSMenuItem(title: openString, action: #selector(showDoorstepFromMenuBar), keyEquivalent: "o")
    ...
    @objc func showDoorstepFromMenuBar() {
        channel?.invokeMethod("showDoorstepFromMenuBar", arguments: nil)
    }
